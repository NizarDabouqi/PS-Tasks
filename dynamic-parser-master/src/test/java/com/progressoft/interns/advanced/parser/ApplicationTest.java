...
class ApplicationTest {
    ...
    private Parser<List<HashMap<String, String>>> parser;
    private ParsedDataUtility<List<HashMap<String, String>>> parsedDataUtility;
    ...
    public void givenInvalidColumnName_whenAnyUtilityMethod_thenThrowUtilityException() {
        ...
        List<HashMap<String, String>> parsedData = parser.parse(getFilePath("sample_1.csv"));
    ...
    public void givenValidParsedData_whenGetSummation_thenReturnCorrectSummation() {
        ...
        List<HashMap<String, String>> parsedData2 = parser.parse(getFilePath("sample_2.csv"));
        ...
        List<HashMap<String, String>> parsedData3 = parser.parse(getFilePath("sample_3.csv"));
