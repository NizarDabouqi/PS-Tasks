...
<div id="container">
    <h2>Assign parking spot to employee:</h2>
    ...
    <form id="assignSpotToEmployee" method="POST">
        ...
        <br>
        <input type="submit" value="Assign" onclick="assignSpotToEmployee()">
...
<script>
    ...
    function goToHome() {
        document.getElementById("assignSpotToEmployee").action = "${pageContext.request.contextPath}/index.jsp";
        document.getElementById("assignSpotToEmployee").submit();
    }
</script>
</html>
