    ...
    <div class="sub-container">
        <c:if test="${empty requestScope.employees}">
            <div class="warning-container">
                <p class="warning-message">No Employees Found</p>
            </div>
        </c:if>
        ...
        <c:if test="${not empty requestScope.employees}">
            ...
            <table>
                <tr>
                    ...
                    <th class="table-header">Delete Employee</th>
                </tr>

                <c:forEach items="${requestScope.employees}" var="employee">
                    <tr>
                        <td class="table-content">${employee.id}</td>
                        <td class="table-content">${employee.name}</td>
